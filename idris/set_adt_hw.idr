...
-- Return the set, s - {v}
set_remove v (mkSet nil) = emptySet
...
tobool:(eq a) => a -> list a -> bool
tobool v nil = false
tobool v (h::t) = ite (member v (h::t))
                           (true)
                           (tobool v t)

set_member v (mkSet nil) = false
set_member v (mkSet l) = (tobool v l)
...
combine nil nil = nil
combine (h::t) nil = (h::t)
combine (h::t) (h2::t2) = (h::t) ++ (list_remove h2 (h::t))
...
intersect nil _ = nil
intersect (h::t) (h2::t2) =  ite (member h (h2::t2))
                           (h::(h2::t2))
                           (h2::t2)

-- Return the intersection of s1 and s2
-- set_intersection: (eq a) => list a -> list a -> list a
set_intersection (mkSet nil) (mkSet nil) = (mkSet (nil))
set_intersection (mkSet l1) (mkSet nil) = (mkSet (nil))
...
list_difference (h::t) nil = nil
list_difference (h::t) (h2::t2) =  ite (member h (h2::t2))
                            (nil)
                            (nil)

set_difference (mkSet nil) _ = (mkSet nil)
...
isItFalse:(eq a) => (a -> bool) -> list a -> bool
isItFalse p nil = true
isItFalse p (h::t) =  ite (p h)
                        (isItFalse p t)
                        (false)

set_forall p (mkSet nil) = false               
set_forall p (mkSet l) = (isItFalse p l)
...
-- Return true if p is true for some v in s, otherwise else false
-- set_exists: (p: a -> bool) -> (s: set a) -> bool
isItTrue: (a -> bool) -> list a -> bool
isItTrue p nil = false
isItTrue p (h::t) = ite (p h)
                (true)
                (isItTrue p t)
                
set_exists p (mkSet nil) = false                
set_exists p (mkSet l) = (isItTrue p l)
...
wat: (a -> bool) -> list a -> option a
wat p nil = none
wat p (h::t) = ite (p h)
                (some h)
                (wat p t)
set_witness p (mkSet nil) = none
set_witness p (mkSet l) = (wat p l)
...
set_eql (mkSet nil) (mkSet l1) = false
set_eql (mkSet l1) (mkSet l2) = eql_set (mkSet l1) (mkSet l2)
